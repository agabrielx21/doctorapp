...
<body>
    ...
    <div class="main-component-2">
        <form id="regForm" action="confirmModificareStoc.php">
            <h1>Modifica stocul unui item din inventarul spitalului</h1>
            <input type="text" pattern="[a-zA-Z]+" id="nume" name="nume" placeholder="item" value="" min="" max="" />
            <input type="number" id="stoc" name="stoc" value="1" min="1" max="100" />
            <input type="date" id="data" name="data" value="" min="" max="" />
