...
<body>
    ...
    <div class="main-component-2">
        <form id="regForm" action="usertodoctor.php">
            <h1>Adaugati un doctor</h1>
            <input type="text" pattern="[a-zA-Z0-9]+" id="nume" name="uname" placeholder="Username" value="" min="" max="" />
            <input type="text" pattern="[a-zA-Z]+" id="specializare" name="specializare" placeholder="Specializare" value="" min="" max="" />
